...
type VscIconNames = keyof typeof VscIcons
...
>(({ name, size, ...props }, ref) => {
  ...
  const namePreffix3 = name.slice(0, 3)
  ...
  const iconsCollection = iconsCollectionMap[namePreffix3] || iconsCollectionMap[namePreffix]
